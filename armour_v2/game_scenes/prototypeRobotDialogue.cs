...
public partial class prototypeRobotDialogue : Node3D, IInteractable
{
	...
	public override void _Ready()
	{
        ...
        _meshInstance = GetNode<MeshInstance3D>("Mesh"); // Adjust the node path as needed
	...
	{
		dialogueManager.StartDialogue("prototypeRobot"); // Ensure DialogueManager is accessible
	}
