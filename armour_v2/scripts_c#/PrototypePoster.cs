...
public partial class PrototypePoster : Node3D, IInteractable
{
    ...
    {
        //dialogueManager.StartDialogue("protoPoster");
        OnExamine();
    }
        ...
        return new List<ContextMenuAction>
    {
        ...
        new ContextMenuAction("Pick Up", OnPickUp),
    ...
    {
        DebugLog("It's a poster of the old king.");
    }
